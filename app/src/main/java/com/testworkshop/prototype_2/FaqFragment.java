...
public class FaqFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = v.findViewById(R.id.custom_toolbar_title);
        ...
        RecyclerView recyclerView = getView().findViewById(R.id.faq_recyclerview);
