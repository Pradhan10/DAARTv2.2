...
public class WatsonDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "watson.db";
    private static final int DATABASE_VERSION = 1;

    public WatsonDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_WATSON_TABLE = "CREATE TABLE" +
                WatsonFeedContract.WatsonEntry.TABLE_NAME + " (" +
                WatsonFeedContract.WatsonEntry._ID + "INTEGER PRIMARY KEY AUTOINCREMENT," +
                WatsonFeedContract.WatsonEntry.COLUMN_NAME_TEXT_TO_ANALYSE + "TEXT NOT NULL, " +
                WatsonFeedContract.WatsonEntry.COLUMN_NAME_PERSON_NAME + "TEXT NOT NULL" +
                " );";
        db.execSQL(SQL_CREATE_WATSON_TABLE);
        final String SQL_INSERT_WATSON_TABLE = "INSERT INTO" +
                WatsonFeedContract.WatsonEntry.TABLE_NAME + " VALUES ('Well, thank you very much, Jim, for this opportunity. I want to thank Governor Romney and the University\n" +
        ...
        db.execSQL(SQL_INSERT_WATSON_TABLE);
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {

        db.execSQL("DROP TABLE IF EXISTS " + WatsonFeedContract.WatsonEntry.TABLE_NAME);
        onCreate(db);
    }
}
